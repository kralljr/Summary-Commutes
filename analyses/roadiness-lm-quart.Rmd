...
quanttab <- rename(quanttab, Variable = name) %>%
  mutate(Variable = factor(Variable, levels = c("mph",
                                                ...
                                                "srness500loc"),
                           labels = c("Speed",
                                      "Road density, Highway/1km",
                                      "Road density, Local/1km",
                                      "Road density, Highway/500m",
                                      "Road density, Local/500m")))  %>%
...
p1tab <- p1$tab %>% mutate(type = "Local")
p2tab <- p2$tab %>% mutate(type = "Highway")
...
```{r}
roadlag1hw <- plot_nocat_senslagQ(SreslS, "Highway", SreslS0, "Local")
roadlag1hw
```
...
```{r}
roadlag500hw <- plot_nocat_senslagQ(SreslS, "Highway", SreslS0, "Local")
roadlag500hw
```
