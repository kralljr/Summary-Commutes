...
resl <- list(Main = res1, Weather = res2, Hourly = res3, Daily = res3b, Rush = res4)
...
resl <- list(Main = res1, Weather = res2, PM = res3, Rush = res4)
