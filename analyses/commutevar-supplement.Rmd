...
## Table S`r k`. Mean (SD) of wind speed (m/s) and temperature (degrees Celsius) for N=45 person-days of observation.
...
## Figure `r k`. Variation in roadiness (in standard deviations (SD)) and speed (mph) over each observed trip (N=69).  
