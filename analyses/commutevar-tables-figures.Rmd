...
ggsave(file = here("figures/fig1.png"))
```
...
ggsave(file = here("figures/fig2.png"), width = 3.5)
...
ggsave(file = here("figures/fig3.png"), width = 4.5, height = 3)
...
ggsave(file = here("figures/fig4.png"), width = 4.5, height = 3)
